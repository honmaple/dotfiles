...
; (require 'init-dash) ;; 搜索
; (require 'init-ledger) ;;记账
;; Extra packages which don't require any configuration

;; (require-package 'gnuplot) ;; 绘图用的
;; (require-package 'lua-mode)
; (require-package 'htmlize) ;; 插入html
